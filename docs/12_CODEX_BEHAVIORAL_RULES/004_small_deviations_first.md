# Small Deviations First

## Purpose
Escalate slowly from plausible wrongness to impossible wrongness.

## Source Basis
Pattern betrayal works best after false familiarity.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `small_deviations_first` and adjacent Wave 02 concepts.
