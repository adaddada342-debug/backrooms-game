# Validate With Absence

## Purpose
Ask what is missing and why it matters.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `validate_with_absence` and adjacent Wave 02 concepts.
