# No Default Monster Horror

## Purpose
Codex must not add monsters/chases as default tension.

## Source Basis
The report explicitly critiques monster-first interpretations.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `no_default_monster_horror` and adjacent Wave 02 concepts.
