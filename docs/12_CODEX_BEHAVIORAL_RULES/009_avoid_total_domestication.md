# Avoid Total Domestication

## Purpose
Do not let tools, bases, or maps fully tame the space.

## Source Basis
Mastery must remain partial.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `avoid_total_domestication` and adjacent Wave 02 concepts.
