# Validate With Route Memory

## Purpose
Ask what the player can remember spatially.

## Source Basis
Navigation scars support attachment and cognitive tension.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `validate_with_route_memory` and adjacent Wave 02 concepts.
