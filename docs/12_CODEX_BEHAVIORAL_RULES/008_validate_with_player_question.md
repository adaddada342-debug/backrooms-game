# Validate With Player Question

## Purpose
Every feature should create or deepen a question.

## Source Basis
Questions sustain curiosity-driven exploration.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `validate_with_player_question` and adjacent Wave 02 concepts.
