# Read Psychology Before Atmosphere

## Purpose
Codex must read Wave 02 files before building atmosphere.

## Source Basis
This prevents visual features from violating the emotional thesis.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `read_psychology_before_atmosphere` and adjacent Wave 02 concepts.
