# Ordinary Before Surreal

## Purpose
Build banal reality first.

## Source Basis
The source image worked because it was real and slightly off.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `ordinary_before_surreal` and adjacent Wave 02 concepts.
