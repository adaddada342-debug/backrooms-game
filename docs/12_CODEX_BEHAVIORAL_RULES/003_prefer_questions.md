...
## Purpose
When choosing between explanation and question, choose question.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `prefer_questions` and adjacent Wave 02 concepts.
