# Liminal Safety Illusion

## Purpose
Initial calm should feel plausible.

## Source Basis
A calming liminal space becomes horrifying when it refuses to end.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `liminal_safety_illusion` and adjacent Wave 02 concepts.
