...
## Purpose
Use spaces built for waiting without any service arriving.

## Source Basis
Waiting rooms, terminals, queues, gates, and lobbies become eerie when the social process is absent.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `waiting_space_uncanny` and adjacent Wave 02 concepts.
