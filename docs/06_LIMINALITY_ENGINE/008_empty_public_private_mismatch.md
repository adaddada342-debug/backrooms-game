...
## Purpose
Violate expected occupancy level.

## Source Basis
The report notes human presence can reduce uncanniness in public places where people should be present.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `empty_public_private_mismatch` and adjacent Wave 02 concepts.
