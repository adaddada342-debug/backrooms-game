...
## Purpose
Use objects associated with passage: signs, tickets, benches, keys, maps.

## Source Basis
Such objects imply transit and absent systems.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `liminal_objects` and adjacent Wave 02 concepts.
