...
## Purpose
Do not overuse obvious endpoints.

## Source Basis
Clear goals and exits restore certainty too quickly.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `no_final_destination` and adjacent Wave 02 concepts.
