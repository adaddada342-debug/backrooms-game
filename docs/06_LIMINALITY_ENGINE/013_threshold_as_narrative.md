# Threshold as Narrative

## Purpose
Crossings should change interpretation, not just location.

## Source Basis
Noclipping and transitions should feel ontological, not like loading doors.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `threshold_as_narrative` and adjacent Wave 02 concepts.
