...
## Purpose
Spaces designed for transition should dominate.

## Source Basis
The report links liminality to thresholds, ambiguity, corridors, roads, malls, hotels, stairwells, and spaces designed to pass through rather than dwell in.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `threshold_spaces` and adjacent Wave 02 concepts.
