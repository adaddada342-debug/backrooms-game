...
## Purpose
Levels should feel between known categories.

## Source Basis
Liminality is ambiguity and transitional state; spaces should blur office/retail/hotel/school categories.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `in_between_identity` and adjacent Wave 02 concepts.
