...
## Purpose
Make clocks, schedules, and waiting loops feel stuck.

## Source Basis
The report identifies time blur and routine without actors as key temporal principles.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `liminal_time` and adjacent Wave 02 concepts.
