...
## Purpose
Let spaces feel personal and alien at once.

## Source Basis
The report says absent people obliterate context and invite viewers to populate images with their own memories.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `eerie_and_intimate` and adjacent Wave 02 concepts.
