# Passing Not Dwelling

## Purpose
Make habitation feel like misuse.

## Source Basis
Liminal spaces are not simply empty; they are transitional. Dwelling in them should feel temporary or wrong.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `passing_not_dwelling` and adjacent Wave 02 concepts.
