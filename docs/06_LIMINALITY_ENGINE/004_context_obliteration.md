# Context Obliteration

## Purpose
Strip away the normal why of a place.

## Source Basis
The report explains that the original image removed doors, windows, people, furniture, activity, and clear destination.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `context_obliteration` and adjacent Wave 02 concepts.
