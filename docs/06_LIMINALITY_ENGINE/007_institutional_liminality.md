...
## Purpose
Schools, offices, hospitals, and malls are strong because players know their social scripts.

## Source Basis
The report notes nostalgia triggers from childhood institutions, routine places, and public interiors.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `institutional_liminality` and adjacent Wave 02 concepts.
