...
## Purpose
Use domestic cues in wrong contexts.

## Source Basis
The Backrooms turns familiar cues into ache by denying reunion or completion.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `almost_home_not_home` and adjacent Wave 02 concepts.
