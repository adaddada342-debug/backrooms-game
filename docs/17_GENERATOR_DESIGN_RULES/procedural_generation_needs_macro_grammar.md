# Procedural Generation Needs Macro Grammar

## Purpose
Define the procedural generation rule 'Procedural Generation Needs Macro Grammar' for Codex and generator systems.
