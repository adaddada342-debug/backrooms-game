# Randomness Versus Grammar Check

## Purpose
Reject procedural noise.

## Source Basis
Procedural generation fails when it uses randomness instead of grammar.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `randomness_vs_grammar_check` and adjacent Wave 02 concepts.
