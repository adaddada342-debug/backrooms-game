...
## Purpose
Detect when detail accumulation replaces depth.

## Source Basis
The report warns lore fails when it confuses accumulation with depth.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `lore_bloat_detector` and adjacent Wave 02 concepts.
