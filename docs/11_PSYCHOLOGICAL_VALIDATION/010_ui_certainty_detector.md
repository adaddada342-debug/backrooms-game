# UI Certainty Detector

## Purpose
Flag UI that restores too much certainty.

## Source Basis
Failure modes warn against loud UI, quest markers, and objective spam.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `ui_certainty_detector` and adjacent Wave 02 concepts.
