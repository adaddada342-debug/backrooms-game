# Player Power Detector

## Purpose
Flag systems that turn adaptation into conquest.

## Source Basis
The player may gain competence but must not fully domesticate the Backrooms.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `player_power_detector` and adjacent Wave 02 concepts.
