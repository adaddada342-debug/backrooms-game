...
## Purpose
Check if absence is active enough.

## Source Basis
Absence should create uncertainty, missing social proof, and evidence-based questions.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `absence_checklist` and adjacent Wave 02 concepts.
