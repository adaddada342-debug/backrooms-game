# Atmosphere Review Checklist

## Purpose
Validate if a feature preserves affective design.

## Source Basis
Features must serve scale, absence, isolation, liminality, curiosity, and incomprehensibility.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `atmosphere_review_checklist` and adjacent Wave 02 concepts.
