# Speed and Sprint Detector

## Purpose
Flag movement that prevents environmental absorption.

## Source Basis
Fast movement and stamina loops can prevent absorption.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `speed_detector` and adjacent Wave 02 concepts.
