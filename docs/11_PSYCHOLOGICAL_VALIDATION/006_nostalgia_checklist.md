...
## Purpose
Check if memory cues are emotionally useful.

## Source Basis
Nostalgia should be bittersweet, socially incomplete, and tied to ordinary past settings.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `nostalgia_checklist` and adjacent Wave 02 concepts.
