# Monster Substitution Detector

## Purpose
Detect when Codex converts atmosphere into chase horror.

## Source Basis
Common failure: constant chasing converts existential dread into ordinary threat.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `monster_substitution_detector` and adjacent Wave 02 concepts.
