# Map Certainty Detector

## Purpose
Flag perfect maps.

## Source Basis
Mapping should be partial, fallible, and personal.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `map_certainty_detector` and adjacent Wave 02 concepts.
