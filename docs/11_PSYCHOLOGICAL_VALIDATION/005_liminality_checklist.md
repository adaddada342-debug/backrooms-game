# Liminality Checklist

## Purpose
Check whether a space is truly liminal.

## Source Basis
A space should be transitional, ambiguous, familiar, and context-stripped.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `liminality_checklist` and adjacent Wave 02 concepts.
