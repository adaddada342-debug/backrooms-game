# Dominant Contradiction Field

## Purpose
Define LevelRecipe data requirements for Dominant Contradiction Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: what is wrong, how player infers it, when it escalates.
