# Level Recipe Master Schema

## Purpose
Define LevelRecipe data requirements for Level Recipe Master Schema.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: level_id, display_name, emotional_thesis, real_world_typology, dominant_contradiction, spatial_grammar, material_palette, lighting_profile, audio_profile, trace_profile, anomaly_budget, exit_rules, resource_rules, vr_constraints, multiplayer_visibility_rules.
