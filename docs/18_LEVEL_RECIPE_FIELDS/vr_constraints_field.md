# VR Constraints Field

## Purpose
Define LevelRecipe data requirements for VR Constraints Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: locomotion comfort, scale limits, flicker safety, interaction clarity.
