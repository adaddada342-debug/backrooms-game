# Emotional Thesis Field

## Purpose
Define LevelRecipe data requirements for Emotional Thesis Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: primary feeling, secondary feeling, comfort-to-dread curve, failure modes.
