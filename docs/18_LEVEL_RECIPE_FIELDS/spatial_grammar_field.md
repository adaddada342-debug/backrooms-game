# Spatial Grammar Field

## Purpose
Define LevelRecipe data requirements for Spatial Grammar Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: macro layout type, corridor rules, room adjacency rules, loop rules.
