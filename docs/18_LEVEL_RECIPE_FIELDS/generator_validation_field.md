# Generator Validation Field

## Purpose
Define LevelRecipe data requirements for Generator Validation Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: seed, warnings, thesis score, legibility score, wrongness score.
