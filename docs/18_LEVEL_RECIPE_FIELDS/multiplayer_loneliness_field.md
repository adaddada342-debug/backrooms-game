# Multiplayer Loneliness Field

## Purpose
Define LevelRecipe data requirements for Multiplayer Loneliness Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: direct contact rarity, asynchronous traces, shared discovery visibility.
