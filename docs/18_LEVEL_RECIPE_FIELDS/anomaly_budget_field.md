# Anomaly Budget Field

## Purpose
Define LevelRecipe data requirements for Anomaly Budget Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: frequency, severity, spatial impact, repeatability, player visibility.
