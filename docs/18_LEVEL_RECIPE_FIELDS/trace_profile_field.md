...
## Purpose
Define LevelRecipe data requirements for Trace Profile Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: human evidence density, maintenance traces, habitation traces, bureaucratic traces.
