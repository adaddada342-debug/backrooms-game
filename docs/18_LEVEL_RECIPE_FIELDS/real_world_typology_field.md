# Real World Typology Field

## Purpose
Define LevelRecipe data requirements for Real World Typology Field.

## Emotional Target
Codex can generate consistent levels because each level carries its emotional and architectural DNA in data.

## Design Rules
- Required subfields: reference building type, public/private/service zones, expected occupants, normal purpose.
