# Realistic Banal Surface

## Purpose
Start with banal ordinary details.

## Source Basis
The source photo’s power came from a mundane interior: drop ceiling, carpet, partitions, fluorescent light.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `realistic_banal_surface` and adjacent Wave 02 concepts.
