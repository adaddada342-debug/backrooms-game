...
## Purpose
Use scale errors as rare shocks.

## Source Basis
The report states scale changes should be rare and devastating.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `wrong_scale` and adjacent Wave 02 concepts.
