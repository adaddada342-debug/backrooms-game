# Coherence Versus Mystery

## Purpose
Balance understandability with exploration pull.

## Source Basis
Environmental-preference research in the report notes people need to understand and explore.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `coherence_vs_mystery` and adjacent Wave 02 concepts.
