# Legibility Undermined

## Purpose
Let local readability coexist with global confusion.

## Source Basis
The report says the Backrooms overfeeds mystery while undermining legibility.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `legibility_undermined` and adjacent Wave 02 concepts.
