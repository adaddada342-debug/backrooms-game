# Architecture Not Set Dressing

## Purpose
Architecture carries emotion and rules.

## Source Basis
The report states the environment itself is the antagonist and a memorable level needs an emotional job.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `architecture_not_set_dressing` and adjacent Wave 02 concepts.
