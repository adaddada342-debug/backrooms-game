# Uncanny Valley of Places

## Purpose
Make places realistic enough to activate expectations, wrong enough to violate them.

## Source Basis
The report cites research framing liminal images as occupying an uncanny valley of physical places.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `uncanny_valley_of_places` and adjacent Wave 02 concepts.
