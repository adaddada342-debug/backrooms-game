...
## Purpose
If everything is weird, nothing is weird.

## Source Basis
The report says if every room is equally strange, nothing is strange.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `deviation_not_noise` and adjacent Wave 02 concepts.
