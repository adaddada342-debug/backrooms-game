...
## Purpose
Use normal typologies, then violate them.

## Source Basis
The report’s first spatial principle states pure strangeness is noise but familiar patterns violated in small ways are uncanny.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `familiarity_wrongness` and adjacent Wave 02 concepts.
