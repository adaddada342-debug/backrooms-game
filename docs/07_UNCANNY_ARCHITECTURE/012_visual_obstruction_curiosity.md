# Visual Obstruction Curiosity

## Purpose
Use partial sightlines.

## Source Basis
Game-design research in the report identifies resolving obstructions as an exploration driver.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `visual_obstruction_curiosity` and adjacent Wave 02 concepts.
