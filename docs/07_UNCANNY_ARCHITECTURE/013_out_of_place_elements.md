...
## Purpose
One wrong object can be better than a whole weird room.

## Source Basis
The report identifies purposeful out-of-place elements as strong exploration drivers.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `out_of_place_elements` and adjacent Wave 02 concepts.
