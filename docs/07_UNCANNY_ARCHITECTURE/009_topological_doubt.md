...
## Purpose
Make the map question itself.

## Source Basis
Non-Euclidean effects should create doubt rather than puzzles.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `topological_doubt` and adjacent Wave 02 concepts.
