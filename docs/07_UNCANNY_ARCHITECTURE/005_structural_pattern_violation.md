...
## Purpose
Break spatial grammar carefully.

## Source Basis
The report says realistic spaces become disturbing when they deviate from familiar structural patterns.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `structural_pattern_violation` and adjacent Wave 02 concepts.
