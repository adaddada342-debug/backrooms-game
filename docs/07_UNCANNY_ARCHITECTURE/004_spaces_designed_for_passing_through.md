# Spaces Designed for Passing Through

## Purpose
Corridors, stairwells, terminals, service halls, and malls should be core assets.

## Source Basis
The report lists these as modern liminal-space examples.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `spaces_designed_for_passing_through` and adjacent Wave 02 concepts.
