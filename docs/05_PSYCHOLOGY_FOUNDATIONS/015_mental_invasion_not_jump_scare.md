# Mental Invasion Not Jump Scare

## Purpose
Let dread accumulate inside the player’s own interpretation.

## Source Basis
The report criticizes games that translate the premise into chases and streamer-bait scares.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `mental_invasion_not_jump_scare` and adjacent Wave 02 concepts.
