...
## Purpose
Emptiness must feel active.

## Source Basis
The report states large empty environments produce existential discomfort and absence becomes part of the anomaly.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `absence_not_neutral` and adjacent Wave 02 concepts.
