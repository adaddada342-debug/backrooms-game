# Surveillance Without Source

## Purpose
Let the player feel observed without confirming an observer.

## Source Basis
The report identifies surveillance-without-source as one condition empty architecture can create.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `surveillance_without_source` and adjacent Wave 02 concepts.
