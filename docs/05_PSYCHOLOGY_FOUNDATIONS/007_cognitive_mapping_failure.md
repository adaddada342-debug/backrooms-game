# Cognitive Mapping Failure

## Purpose
Let players map locally while doubting the whole.

## Source Basis
Wayfinding research in the report says windowless interiors and lack of external cues can create unease and loss of control.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `cognitive_mapping_failure` and adjacent Wave 02 concepts.
