...
## Purpose
Every space should create questions.

## Source Basis
The report says the player keeps going because every corridor suggests more than it reveals and every trace seems like evidence.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `question_generation_engine` and adjacent Wave 02 concepts.
