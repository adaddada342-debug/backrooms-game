...
## Purpose
Fear should come from uncertainty, not known enemies.

## Source Basis
Research cited in the report links creepiness to ambiguous threat and uncertainty.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `ambiguous_threat` and adjacent Wave 02 concepts.
