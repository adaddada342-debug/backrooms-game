# Derealisation-Like Unreality

## Purpose
Make normal categories slowly lose stability.

## Source Basis
The report repeatedly links the long arc to derealised acclimatisation, not simple fear.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `derealisation_like_unreality` and adjacent Wave 02 concepts.
