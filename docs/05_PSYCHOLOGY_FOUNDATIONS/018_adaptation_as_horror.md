# Adaptation as Horror

## Purpose
Make players fear becoming fluent in the place.

## Source Basis
The report says late play should culminate in the horror of fluency in an environment no human should be fluent in.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `adaptation_as_horror` and adjacent Wave 02 concepts.
