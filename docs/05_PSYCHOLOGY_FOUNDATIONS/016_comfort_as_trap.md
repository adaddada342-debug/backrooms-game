...
## Purpose
Let calming places become suspicious through duration.

## Source Basis
The report’s progression model includes false familiarity before pattern betrayal.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `comfort_as_trap` and adjacent Wave 02 concepts.
