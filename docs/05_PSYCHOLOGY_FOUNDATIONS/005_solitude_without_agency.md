# Solitude Without Agency

## Purpose
Make isolation feel imposed, not chosen.

## Source Basis
The report distinguishes positive solitude from forced isolation and notes that the Backrooms removes voluntariness and control.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `solitude_without_agency` and adjacent Wave 02 concepts.
