# Not a Lore Compendium

## Purpose
Do not mistake lore accumulation for depth.

## Source Basis
The report warns that the strongest question is what structural conditions create the Backrooms feeling, not what every wiki fact says.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `not_lore_compendium` and adjacent Wave 02 concepts.
