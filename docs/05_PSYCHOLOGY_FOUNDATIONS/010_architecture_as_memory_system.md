...
## Purpose
Make buildings behave like half-remembered, contradictory memories.

## Source Basis
The source report calls this the single strongest summary of why the Backrooms works.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `architecture_as_memory_system` and adjacent Wave 02 concepts.
