# Environmental Psychology Core

## Purpose
Use human expectations about spaces against the player.

## Source Basis
The report connects wayfinding, coherence, legibility, mystery, and complexity to Backrooms affect.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `environmental_psychology_core` and adjacent Wave 02 concepts.
