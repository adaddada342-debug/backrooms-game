# Pattern Betrayal Psychology

## Purpose
Betray learned rules one at a time.

## Source Basis
The progression model says the game should let players form rules, then break one expectation at a time.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `pattern_betrayal_psychology` and adjacent Wave 02 concepts.
