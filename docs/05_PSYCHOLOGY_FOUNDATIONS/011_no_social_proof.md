...
## Purpose
Remove normal human confirmation.

## Source Basis
The report says empty architecture with no people, no activity, and no context withholds social proof.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `no_social_proof` and adjacent Wave 02 concepts.
