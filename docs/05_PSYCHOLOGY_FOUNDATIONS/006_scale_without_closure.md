# Scale Without Informational Closure

## Purpose
Never let scale become fully measurable.

## Source Basis
The report defines Backrooms scale as more than bigness: scale without informational closure.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `scale_without_closure` and adjacent Wave 02 concepts.
