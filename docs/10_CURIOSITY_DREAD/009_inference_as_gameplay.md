# Inference as Gameplay

## Purpose
Inspecting, comparing, and doubting should be core play.

## Source Basis
The report says fear grows when players can inspect, infer, compare, and doubt.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `inference_as_gameplay` and adjacent Wave 02 concepts.
