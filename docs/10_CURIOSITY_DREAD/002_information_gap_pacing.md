# Information Gap Pacing

## Purpose
Sustain curiosity by revealing partial patterns.

## Source Basis
Curiosity theory in the report defines curiosity as pursuit of knowledge under novelty, ambiguity, challenge, and uncertainty.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `information_gap_pacing` and adjacent Wave 02 concepts.
