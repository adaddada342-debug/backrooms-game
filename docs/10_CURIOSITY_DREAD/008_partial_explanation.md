...
## Purpose
Give theories, not final answers.

## Source Basis
The report says never explain the whole system and keep rules partial and revisable.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `partial_explanation` and adjacent Wave 02 concepts.
