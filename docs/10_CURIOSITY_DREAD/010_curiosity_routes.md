...
## Purpose
Use perceptual, conceptual, ambiguity, and manipulatory curiosity.

## Source Basis
The report cites game-design research on curiosity routes.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `curiosity_routes` and adjacent Wave 02 concepts.
