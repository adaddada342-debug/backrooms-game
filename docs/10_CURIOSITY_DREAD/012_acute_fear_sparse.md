...
## Purpose
Acute fear should be intermittent, not constant.

## Source Basis
The report says Backrooms needs curiosity, unease, comfort, routine, doubt, suspicion, obsession, and scale shock, not always crisis.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `acute_fear_sparse` and adjacent Wave 02 concepts.
