...
## Purpose
Every system should create durable questions.

## Source Basis
The report says mystery is powerful because explanation compresses possibility.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `questions_over_answers` and adjacent Wave 02 concepts.
