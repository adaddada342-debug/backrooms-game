# Exploration Without Victory

## Purpose
The reward is understanding, not conquest.

## Source Basis
The report says players keep going because the space generates questions, not because they are promised victory.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `exploration_without_victory` and adjacent Wave 02 concepts.
