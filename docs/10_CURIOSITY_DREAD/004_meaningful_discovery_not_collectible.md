# Meaningful Discovery Not Collectible

## Purpose
Discoveries should change theory, route, or emotion.

## Source Basis
The report explicitly says discovery must feel meaningful, not collectible.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `meaningful_discovery_not_collectible` and adjacent Wave 02 concepts.
