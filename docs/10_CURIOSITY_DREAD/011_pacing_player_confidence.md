# Pacing Player Confidence

## Purpose
Build comfort before betrayal.

## Source Basis
Familiarity itself should deliver horror.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `pacing_player_confidence` and adjacent Wave 02 concepts.
