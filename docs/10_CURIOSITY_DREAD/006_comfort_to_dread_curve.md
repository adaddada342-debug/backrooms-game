# Comfort to Dread Curve

## Purpose
Start strangely calming and become horrifying by implication.

## Source Basis
The progression model begins with threshold shock and investigative curiosity, then false familiarity and betrayal.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `comfort_to_dread_curve` and adjacent Wave 02 concepts.
