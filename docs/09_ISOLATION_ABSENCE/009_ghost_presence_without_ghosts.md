# Ghost Presence Without Ghosts

## Purpose
Use human traces, not supernatural reveals.

## Source Basis
The project should avoid monster-first interpretations.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `ghost_presence_without_ghosts` and adjacent Wave 02 concepts.
