...
## Purpose
Let the building look cared for by nobody visible.

## Source Basis
Tiny maintenance can be more disturbing than ruin alone.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `unseen_maintenance` and adjacent Wave 02 concepts.
