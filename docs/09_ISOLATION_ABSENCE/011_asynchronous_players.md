# Asynchronous Player Presence

## Purpose
Multiplayer should often be traces, not constant party chatter.

## Source Basis
Wave 01 and the report emphasize multiplayer preserving loneliness.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `asynchronous_players` and adjacent Wave 02 concepts.
