...
## Purpose
Make solitude forced and uncontrollable.

## Source Basis
The report distinguishes positive solitude from forced isolation.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `imposed_loneliness` and adjacent Wave 02 concepts.
