...
## Purpose
Remove crowds, staff, and visible institutions.

## Source Basis
The original image stripped normal context, people, and activity.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `social_proof_removed` and adjacent Wave 02 concepts.
