# Absence as Antagonist

## Purpose
The place pressures the player by withholding people and answers.

## Source Basis
The report’s narrative principles state absence is stronger than presence and environment itself is antagonist.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `absence_as_antagonist` and adjacent Wave 02 concepts.
