# Empty Spaces Over Explicit Threats

## Purpose
Do not simplify fear into enemy avoidance.

## Source Basis
The report says a monster gives the mind a task; empty architecture withholds the object of fear.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `empty_spaces_over_explicit_threats` and adjacent Wave 02 concepts.
