...
## Purpose
Do not imply help is reliably coming.

## Source Basis
Being lost is the antagonist’s method.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `no_rescue_fantasy` and adjacent Wave 02 concepts.
