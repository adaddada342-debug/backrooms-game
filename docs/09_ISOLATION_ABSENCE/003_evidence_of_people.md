...
## Purpose
Traces should prove presence while preserving absence.

## Source Basis
The report says evidence of people is scarier than people themselves.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `evidence_of_people` and adjacent Wave 02 concepts.
