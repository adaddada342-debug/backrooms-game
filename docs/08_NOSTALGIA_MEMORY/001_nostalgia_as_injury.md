...
## Purpose
Use memory cues without reunion.

## Source Basis
The report says the Backrooms weaponises nostalgia by offering familiar environments emptied of meaningful people.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `nostalgia_as_injury` and adjacent Wave 02 concepts.
