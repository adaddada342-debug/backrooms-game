# Front-World Remainders

## Purpose
Use objects from normal life as emotional anchors.

## Source Basis
Traces and ordinary objects imply people and histories without showing them.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `front_world_remainders` and adjacent Wave 02 concepts.
