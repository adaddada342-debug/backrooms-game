# Cue Without Completion

## Purpose
Give sensory memory triggers but deny the social event.

## Source Basis
The report says the Backrooms gives the cue without the completion.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `cue_without_completion` and adjacent Wave 02 concepts.
