# Familiar Music Absent Source

## Purpose
Use distant tunes without confirming origin.

## Source Basis
Unverified cues preserve ambiguity and memory ache.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `familiar_music_absent_source` and adjacent Wave 02 concepts.
