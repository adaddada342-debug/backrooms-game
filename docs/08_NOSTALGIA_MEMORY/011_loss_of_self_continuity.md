...
## Purpose
Make normal reality feel less stable over time.

## Source Basis
Nostalgia usually supports self-continuity; Backrooms design can fracture it.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `loss_of_self_continuity` and adjacent Wave 02 concepts.
