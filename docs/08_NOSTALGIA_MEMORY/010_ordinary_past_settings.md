# Ordinary Past Settings

## Purpose
Use routine places, not epic fantasy.

## Source Basis
The strongest Backrooms spaces resemble boring real environments.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `ordinary_past_settings` and adjacent Wave 02 concepts.
