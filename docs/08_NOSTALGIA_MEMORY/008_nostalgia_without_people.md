# Nostalgia Without People

## Purpose
Remove the social body from remembered spaces.

## Source Basis
The Backrooms denies the people who made places meaningful.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `nostalgia_without_people` and adjacent Wave 02 concepts.
