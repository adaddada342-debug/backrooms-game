...
## Purpose
Do not make nostalgia purely warm.

## Source Basis
Nostalgia is typically bittersweet and tied to self-continuity and meaning.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `bittersweet_memory` and adjacent Wave 02 concepts.
