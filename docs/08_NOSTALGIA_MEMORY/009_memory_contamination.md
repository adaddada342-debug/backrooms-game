...
## Purpose
Let later spaces borrow motifs from earlier ones.

## Source Basis
The report says later spaces should feel like corrupted recollections of earlier ones.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `memory_contamination` and adjacent Wave 02 concepts.
