...
## Purpose
Schools, pools, libraries, and malls should feel remembered but not owned.

## Source Basis
The report lists childhood institutions and ordinary past settings as powerful triggers.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `childhood_institutions` and adjacent Wave 02 concepts.
