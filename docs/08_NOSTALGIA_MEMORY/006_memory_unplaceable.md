# Memory That Cannot Be Placed

## Purpose
Make players feel they recognise something without knowing why.

## Source Basis
The report says the sensation can feel like grief, yearning, or a memory that cannot be placed.
...
## Codex Instructions
- Before editing code or content related to this concept, search the docs for `memory_unplaceable` and adjacent Wave 02 concepts.
