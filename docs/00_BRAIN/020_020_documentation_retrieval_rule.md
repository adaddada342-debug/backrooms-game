# 020 Documentation Retrieval Rule

## Purpose
Keeps the archive usable.

## Source Extract
Each file should be atomic so Codex can retrieve relevant knowledge without reading the entire archive every time.
