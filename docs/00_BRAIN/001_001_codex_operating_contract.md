# 001 Codex Operating Contract

## Purpose
Hard behaviour contract for Codex/Cursor.

## Source Extract
Codex is an implementation agent, not the creative authority. It must preserve the emotional thesis and avoid converting the game into generic chase horror.
