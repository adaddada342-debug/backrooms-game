# 007 Anti Horror Manifesto

## Purpose
Protects the project from cheap horror creep.

## Source Extract
Explicit threats simplify fear. Empty architecture preserves ambiguity, uncertainty, and existential dread.
