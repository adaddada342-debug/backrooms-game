# 008 Architecture As Antagonist

## Purpose
Defines the main antagonist.

## Source Extract
The environment itself is the antagonist; it applies pressure through scale, incoherence, isolation, and partial legibility.
