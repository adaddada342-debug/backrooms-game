...
## Purpose
Controls scale and infinity.

## Source Extract
The player must infer impossible scale through failed measurement and repeated disorientation, not through UI bragging alone.
