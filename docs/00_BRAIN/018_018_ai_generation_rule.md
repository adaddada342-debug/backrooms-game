# 018 Ai Generation Rule

## Purpose
Defines how AI is allowed to help.

## Source Extract
AI may propose recipes, anomalies, and level theses, but validated systems must construct the world safely.
