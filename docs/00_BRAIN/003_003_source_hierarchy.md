# 003 Source Hierarchy

## Purpose
Defines which documents override others.

## Source Extract
Master brain > operating contract > wave indexes > specific design files > implementation files > generated code comments.
