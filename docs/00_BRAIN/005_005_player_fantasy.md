...
## Purpose
Defines what the player is actually doing emotionally.

## Source Extract
The player is not a hero or monster hunter; the player is an explorer being slowly psychologically colonised by impossible empty places.
