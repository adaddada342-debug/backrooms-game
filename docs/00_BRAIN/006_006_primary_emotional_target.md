# 006 Primary Emotional Target

## Purpose
Defines the intended emotion.

## Source Extract
The target is active terror of nothingness: the dread that there may be nothing behind the next million corners.
