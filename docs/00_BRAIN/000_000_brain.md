...
## Purpose
Master brain for the project. Codex must read this first.

## Source Extract
The project is an exploration-first, liminality-first Backrooms game where fear comes from absence, scale, uncertainty, architecture, and psychological erosion rather than monsters.
