# Non Euclidean Effects Should Create Doubt Not Puzzles First

## Purpose
Define how to use the spatial rule 'Non Euclidean Effects Should Create Doubt Not Puzzles First' in level construction.
