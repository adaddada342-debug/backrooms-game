# 005 Original Image Lesson

## Purpose
Condenses the original image lesson.

## Source Extract
The original image worked because it was banal, realistic, stripped of context, empty, and sensory: carpet, mono-yellow, fluorescent hum, segmented rooms, no destination.
