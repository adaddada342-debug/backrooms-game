# 007 Empty Space Over Threat

## Purpose
Explains why empty spaces beat enemies.

## Source Extract
A monster gives the mind a task. Empty architecture withholds the object of fear and leaves only conditions.
